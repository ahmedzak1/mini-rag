...
Revision ID: 2487b50d39bf
Revises: 
Create Date: 2026-03-11 22:31:25.752249
...
def upgrade() -> None:
    ...
    op.create_index('ix_asset_id', 'assets', ['asset_project_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('ix_asset_id', table_name='assets')
